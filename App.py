...
st.title('Dự đoán giá nhà ở California')
st.sidebar.header('Nhập các giá trị dự đoán')
...
st.write('Ứng dụng dự đoán giá nhà ở California bằng mô hình hồi quy tuyến tính.')
